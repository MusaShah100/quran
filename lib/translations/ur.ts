export const ur = {
  ...
  nav: {
    ...
    getFreeTrial: "مفت آزمائشی کلاس حاصل کریں",
    getRegistered: "رجسٹر کریں",
  },
  // Homepage
  home: {
    hero: {
  ...
  pricing: {
    ...
    fixedPricing: {
      ...
      note: {
        title: "لچکدار ادائیگی",
        description: "آپ اپنے منتخب کردہ پلان کے لیے قیمت کی حد کے اندر کوئی بھی رقم منتخب کر سکتے ہیں۔ ادائیگی ماہانہ ہے اور آپ کی ضروریات کے مطابق ایڈجسٹ کی جا سکتی ہے۔",
      },
    },
    incomeBased: {
      ...
      note: {
        title: "تعلیم کو قابل رسائی بنانا",
        description: "ہمارا خیال ہے کہ مالی حالات قرآن سیکھنے میں رکاوٹ نہیں ہونے چاہئیں۔ ہمارا آمدنی پر مبنی قیمتی ماڈل یقینی بناتا ہے کہ ہر کوئی معیاری اسلامی تعلیم تک رسائی حاصل کر سکے۔",
      },
    },
    courses: {
      title: "دستیاب کورسز",
      description: "تمام قیمتی منصوبے ان کورسز پر لاگو ہوتے ہیں:",
    },
    cta: {
      title: "سیکھنا شروع کرنے کے لیے تیار ہیں؟",
      description: "آج اپنا قیمتی ماڈل منتخب کریں اور کورس میں داخلہ لیں۔ ہماری ٹیم 24 گھنٹوں کے اندر کلاس کے اوقات پر بات چیت کے لیے آپ سے رابطہ کرے گی۔",
    },
  },
  // Common
  common: {
