  ...
  return (
    <footer className="border-t bg-muted/40">
      ...
      <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
        <div className="bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg cursor-pointer transition-all hover:scale-110">
          <a
            href="https://wa.me/1234567890?text=Hello! I need help with QuranLearn platform"
            target="_blank"
        ...
        <div className="bg-blue-500 hover:bg-blue-600 text-white p-3 rounded-full shadow-lg cursor-pointer transition-all hover:scale-110">
          <a
      ...
      <div className="container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="font-semibold mb-3">{t.footer.learning}</h3>
            <ul className="space-y-2 text-sm">
              <li><Link href="/quran" className="text-muted-foreground hover:text-primary">{t.footer.quranReader}</Link></li>
              <li><Link href="/games" className="text-muted-foreground hover:text-primary">{t.footer.learningGames}</Link></li>
              <li><Link href="/courses" className="text-muted-foreground hover:text-primary">{t.nav.courses}</Link></li>
              <li><Link href="/videos" className="text-muted-foreground hover:text-primary">{t.footer.studentVideos}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/teachers" className="text-muted-foreground hover:text-primary">{t.footer.ourTeachers}</Link></li>
              <li><Link href="/about" className="text-muted-foreground hover:text-primary">{t.footer.aboutUs}</Link></li>
              <li><Link href="/updates" className="text-muted-foreground hover:text-primary">{t.nav.updates}</Link></li>
              <li><Link href="/faq" className="text-muted-foreground hover:text-primary">{t.footer.faq}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-center gap-2">
                ...
                <span>learn@quranlearn.com</span>
              </li>
              <li className="flex items-center gap-2">
